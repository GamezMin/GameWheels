...
namespace GameFrame.Editor
{
    public static class Macro
    {
        ...
        [MenuItem("框架工具/宏定义/" + ShowAssert, true, 0)]
        private static bool CommonAssertDisableValidateV()
        {
            Menu.SetChecked("框架工具/宏定义/" + ShowAssert, MacroDefineHelper.Contains(ShowAssert));
            return true;
        }


        [MenuItem("框架工具/宏定义/" + ShowAssert, priority = 0)]
        ...
        [MenuItem("框架工具/UI/Auto Update Gen Code", true)]
        private static bool AutoUpdateValidate()
        {
            Menu.SetChecked("框架工具/UI/Auto Update Gen Code", UnityEditor.EditorPrefs.HasKey(EditorPrefsKey.KeyAuto));
            return true;
        }

        [MenuItem("框架工具/UI/Auto Update Gen Code")]
