namespace GameFrame.Runtime
{
    public static class SceneFactory
    {
        ...
        {
            IScene scene = EntityHouse.Instance.AddSceneEntity<T>(SceneType.PlayerScene, GameFrame.Instance.RootEntity);
            return (T) scene;
        }
        ...
        {
            IScene scene = EntityHouse.Instance.AddSceneEntity<T>(SceneType.OtherPlayerScene, GameFrame.Instance.RootEntity);
            return (T) scene;
        }
